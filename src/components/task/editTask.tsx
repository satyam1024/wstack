...
const EditTask = ({ change,todo }: {change: UseMutationResult<any, Error, { id: string; title: string },unknown >, todo: TaskProps }) => {
      ...
      {editTodoState ? (
        <div className="flex flex-row justify-center items-center">
          ...
          <div className="flex justify-center flex-col ">
            ...
            <button type="button" className="text-white  focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none bg-blue-500" onClick={()=>change.mutate({ id: todo.id, title: input })} >Save</button>
